...
Write-Host "== Ensuring prerequisites for LP02/M02 (env, ACR, image, container app) =="
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "Container app '$AcaApp' not found - creating (LP02/M01 likely hasn't run)..."
